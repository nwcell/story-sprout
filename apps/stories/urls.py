...
urlpatterns = [
    ...
    path(
        "<uuid:story_uuid>/description/editable/",
        htmx_views.EditableStoryDescriptionView.as_view(),
    ...
    path(
        "pages/<int:page_id>/check-generating-status/",
        views.check_content_generating_status,
        name="check_content_generating_status",
    ),
