...
def subscription_page(request):
    try:
        ...
        return render(
            ...
            {"subscription": subscription, "STRIPE_PUBLIC_KEY": settings.STRIPE_PUBLIC_KEY},
        )
    except StripeCustomer.DoesNotExist:
        return render(request, "subscriptions/subscription.html", {"STRIPE_PUBLIC_KEY": settings.STRIPE_PUBLIC_KEY})
